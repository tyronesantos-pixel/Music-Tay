...
export const PlaylistsDropdownModal: React.FC<PlaylistsDropdownModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      <div
        className="w-full sm:max-w-lg bg-[#16141f] border border-violet-500/20 rounded-t-3xl sm:rounded-2xl shadow-2xl flex flex-col max-h-[85vh] overflow-hidden animate-in slide-in-from-bottom sm:zoom-in-95 duration-200"
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 sm:p-5 border-b border-white/10 bg-[#13111a]">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded-full bg-violet-600 text-white text-[10px] font-extrabold shadow-sm">
                  {collections.length}
                </span>
              </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 rounded-full bg-gradient-to-r from-violet-600 via-indigo-600 to-cyan-500 hover:from-violet-500 hover:to-cyan-400 text-white text-xs font-bold transition-all flex items-center gap-1.5 shadow-md shadow-violet-600/25 cursor-pointer transform active:scale-95"
            >
          ...
          <div className="p-3 border-b border-white/5 bg-[#0f0d14]">
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[#1b1825] text-white text-xs pl-9 pr-3 py-2 rounded-xl focus:outline-none focus:ring-1 focus:ring-violet-500 placeholder:text-zinc-500 border border-white/5"
              />
            </div>
          </div>
        )}
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-3 sm:p-4 space-y-2">
          {collections.length === 0 ? (
            <div className="text-center py-10 px-4 flex flex-col items-center">
              <div className="w-16 h-16 rounded-2xl bg-[#1e1b29] flex items-center justify-center text-zinc-500 mb-3 border border-white/5">
              ...
              <p className="text-xs text-zinc-400 max-w-xs mb-5">
                Crie sua primeira playlist para organizar seus videoclipes, músicas e vídeos de games favoritos.
              </p>
              <button
                onClick={() => {
                  onClose();
                ...
                className="px-5 py-2.5 rounded-full bg-gradient-to-r from-violet-600 via-indigo-600 to-cyan-500 hover:from-violet-500 hover:to-cyan-400 text-white text-xs font-extrabold flex items-center gap-2 shadow-lg shadow-violet-600/30 cursor-pointer"
              >
            ...
            filtered.map((col) => {
              ...
              return (
                <div
                  ...
                  className="group flex items-center justify-between p-3 rounded-xl bg-[#1c1926] hover:bg-[#232030] border border-white/5 hover:border-violet-500/40 transition-all cursor-pointer shadow-sm hover:shadow-md"
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    {count > 0 && (
                      <button
                        ...
                        className="w-9 h-9 rounded-full bg-gradient-to-r from-violet-600 to-cyan-500 hover:from-violet-500 hover:to-cyan-400 text-white flex items-center justify-center shadow-md shadow-violet-600/25 transform active:scale-95 transition-transform cursor-pointer"
                      >
                        <Play className="w-4 h-4 fill-current ml-0.5" />
                      </button>
                    )}
                    <span className="text-xs text-zinc-400 group-hover:text-white px-2 py-1 rounded-md bg-[#252132] text-[11px] font-medium hidden sm:inline-block">
                      Abrir
                    </span>
                  </div>
                </div>
        ...
        {/* Footer info */}
        <div className="p-3 border-t border-white/10 bg-[#13111a] flex items-center justify-between text-[11px] text-zinc-400">
          <span>
            Toque em uma playlist para gerenciar ou no <span className="text-violet-400 font-bold">▶</span> para ouvir
          </span>
          <button
            onClick={() => {
              onClose();
            ...
            className="text-violet-400 hover:text-violet-300 hover:underline font-semibold flex items-center gap-1 cursor-pointer"
          >
